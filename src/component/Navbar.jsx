...
function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between h-20">
      ...
      {navOn &&
        <>
          <div ref={firstLayer} className='fixed top-0 left-0 w-full h-screen bg-[#E6EAF5] z-30'></div>

          <div ref={secondLayer} className='fixed top-0 left-0 w-full h-screen flex flex-col items-center justify-center bg-[#090909] z-40'>
            ...
            <div ref={socialRef} className='flex items-center space-x-6 mt-12'>
              <a href='https://www.facebook.com/profile.php?id=100076472701454' target='_blank'>
                <svg className='cursor-pointer hover:scale-110 duration-300' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 64 64">
              ...
              <a href='https://www.instagram.com/official_cranium?igsh=MWU0N3ZicjdscjlvMg==' target='_blank'>
                <svg className='cursor-pointer hover:scale-110 duration-300' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 50 50">
